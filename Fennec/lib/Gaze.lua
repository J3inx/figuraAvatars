...
local eyeMeta = {
  __type = "FOXGaze.Eye", "FOXGaze.Eye2",
...
local blinkMeta = {
  __type = "FOXGaze.Blink", "FOXGaze.Blink2",
  __index = function(_, key)
...
---@field lookChance number `0.4` A number from 0 to 1, the chance at which the gaze will automatically change
---@field blinkFrequency number `4` How often in ticks the gaze has a chance to blink
